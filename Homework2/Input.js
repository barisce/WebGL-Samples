...
function detectObject() {
    ...
    // rBird = math.distance(window.bird.mesh.getMinimumVertexValues(), window.bird.mesh.getMaximumVertexValues());
    rBird = 2;
    ...
    // rHorse = math.distance(window.horse.mesh.getMinimumVertexValues(), window.horse.mesh.getMaximumVertexValues()); // this is object's vertices not localVertices
    rHorse = 2;
    ...
    // rFish = math.distance(window.fish.mesh.getMinimumVertexValues(), window.fish.mesh.getMaximumVertexValues()); // this is object's vertices not localVertices
    rFish = 2;
    ...
    // rFrog = math.distance(window.frog.mesh.getMinimumVertexValues(), window.frog.mesh.getMaximumVertexValues()); // this is object's vertices not localVertices
    rFrog = 2;
    ...
    // rBear = math.distance(window.bear.mesh.getMinimumVertexValues(), window.bear.mesh.getMaximumVertexValues()); // this is object's vertices not localVertices
    rBear = 2;
