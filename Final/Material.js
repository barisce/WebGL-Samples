function Material(program){
    ...
    this.sendLightInfo = function(camera){
        if(window.light){
            ...
            if (this.program.grainEffectUniform != null) {
                gl.uniform1f(this.program.grainEffectUniform, window.grainEffect);
            }
            if (this.program.attenuationUniform != null) {
                gl.uniform1f(this.program.attenuationUniform, window.light.attenuation);
            }
        }
    }
